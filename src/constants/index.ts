...
export const workExperiences = [
  ...
  },
  {
    ...
    duration: '2022 - 2023',
    title:
      'BSTU "VOENMEH" named after D.F. Ustinov is a state university specializing in the training of specialists for enterprises of the military-industrial complex. Our university offers training in engineering and technical fields and specialties: rocket systems and astronautics, radio engineering, instrumentation, laser technology and laser technologies, mechanical engineering, applied mechanics, mechatronics and robotics, ammunition and fuses, design, production and operation of rockets and rocket and space complexes, aircraft control systems and others.',
    icon: '/assets/voenmeh.svg',
    animation: 'clapping',
  },
];
